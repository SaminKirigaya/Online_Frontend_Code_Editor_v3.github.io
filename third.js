...
function htmltagcomplete(){
  ...
  if (endpoint!=0 && startpoint >= 0){
      ...
      if(!(htmlEditor.value.slice(startpoint, endpoint).includes("/")) && !(htmlEditor.value.slice(startpoint, endpoint).includes("br")) && !(htmlEditor.value.slice(startpoint, endpoint).includes("img"))){
...
function jstagcomplete(){
  ...
  if (endpoint2!=0 && startpoint2 >= 0){
      ...
      if(!(jsEditor.value.slice(startpoint2, endpoint2).includes("/")) && !(jsEditor.value.slice(startpoint2, endpoint2).includes("br")) && !(jsEditor.value.slice(startpoint2, endpoint2).includes("img"))){
